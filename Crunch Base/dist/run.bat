@echo off
title Crunch Base Bot Setup and Run Script by @MeoMunDep
color 0A

:MENU
cls
echo =================================================================
echo    Crunch Base BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if not exist configs.json (
    ...
    echo   "referralCode": "meomun115r">> configs.json
    echo }>> configs.json
